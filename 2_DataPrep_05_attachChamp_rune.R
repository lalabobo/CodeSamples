...
library(DBI)
library(RMySQL)
# this script (execSQLattach) does
...
execSQLattach<-function(nameDateList)
{
    ...
    # i is the index in nameDateList
    ...
    b<-i # b is the index of a starting date
    ...
    else 
    {
        for (i in b:length(nameDateList))
        {
            ...
            # only a finished nameDate (03-TransParticipant.R) can continue
